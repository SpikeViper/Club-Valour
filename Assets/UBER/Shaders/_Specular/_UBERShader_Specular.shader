Shader "UBER - Specular Setup/ Core"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature_local ___ _PARALLAXMAP _PARALLAX_POM _PARALLAX_POM_ZWRITE _PARALLAX_POM_SHADOWS
			// keywords available in 2 layers mode
			//#pragma shader_feature_local ___ _PARALLAXMAP _PARALLAXMAP_2MAPS
		...
		*/			
		...
		Pass
		{
			...
			#pragma shader_feature_local ___ _DETAIL_SIMPLE _DETAIL_TEXTURED _DETAIL_TEXTURED_WITH_SPEC_GLOSS
		...
		Pass {
			...
			// keywords available in regular mode
			#pragma shader_feature_local ___ _PARALLAX_POM_ZWRITE
			// keywords available in 2 layers mode
			//#pragma shader_feature_local ___ _PARALLAXMAP _PARALLAXMAP_2MAPS
		...
		Pass
		{
			...
			#pragma shader_feature_local ___ _PARALLAXMAP
			// we don't have it in 2-layers mode
			#pragma shader_feature_local ___ _DETAIL_SIMPLE _DETAIL_TEXTURED _DETAIL_TEXTURED_WITH_SPEC_GLOSS
